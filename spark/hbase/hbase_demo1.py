...
if __name__ == '__main__':
    # client = HBaseClient("192.168.170.101")
    client = HBaseClient("192.168.2.190")

    # client.create_table('student', 'name', 'course')

    # client.put('student', '1', {"name:": "Jack", "course:art": "88", "course:math": "12"})
    # client.put('student', '2', {"name:": "Tom", "course:art": "90", "course:math": "1000"})
    # client.put('student', '3', {"name:": "Jerry"})

    for v in client.scan("GROUND:THM_ANTA_SCHE"):
        print v
