...
if __name__ == '__main__':
    ...
    hbase_rdd = hbase_util.get_hbase_rdd(sc, table='posture_1000w')
    values = hbase_rdd.values().repartition(18)
    ...
    valid_rdd = init_rdd.filter(filter_data).cache()
